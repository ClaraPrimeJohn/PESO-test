    ...
    return (
        <div className="text-center py-36 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${Banner})` }}>
            <div className="py-12 px-8 mx-auto rounded-lg max-w-4xl">
                ...
                <button
                    className="bg-blue text-white text-lg px-6 py-2 rounded-lg shadow-md hover:bg-darkblue hover:scale-105 hover:shadow-lg transition-all duration-300 ease-in-out"
